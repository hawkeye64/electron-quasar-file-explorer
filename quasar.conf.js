  ...
  return {
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'dev.jeffgalbraith.electron-quasar-file-explorer',
        copyright: 'MIT Copyright © 2018-2020 Jeff Galbraith',
        productName: 'Electron Quasar File Explorer',
        asar: true,
        fileAssociations: [
          {
            ext: 'mp4',
        ...
        win: {
          legalTrademarks: 'MIT Copyright © 2018-2020 Jeff Galbraith',
